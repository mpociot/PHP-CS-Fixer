 ...
 */
final class Psr4Fixer extends AbstractFixer implements ConfigAwareInterface
{
    protected $config;
    ...
    {
        return 'Classes must be at least one namespace deep and the class name should match the file name. Warning: This could change code behavior.';
    }
